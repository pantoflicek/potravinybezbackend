package cz.vse.potravinyBEZ.configuration.security.isAuth;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(cz.vse.potravinyBEZ.configuration.security.isAuth.IsAuthenticated)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(cz.vse.potravinyBEZ.configuration.security.isAuth.IsAuthenticated)")
